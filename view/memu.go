...
func Menu() {
	...
	utils.ColorPrint(attributes[:], "    更新地址:", "https://github.com/Doraemonkeys/CDU_ISP_Tool/releases\n")
	color.Green("************************************************************************")
}
...
func Clock_IN_Success(user model.UserInfo) {
	...
	utils.ColorPrint(attributes[:], ">>>>>>>>>>>>>>>ID  ", user.UserID, "    健康登记打卡  ", "成功", "！\n")
	fmt.Println("**************************************************************")
}
...
func Clock_IN_Failed(user model.UserInfo) {
	...
	utils.ColorPrint(attributes[:], ">>>>>>>>>>>>>>>ID  ", user.UserID, "    健康登记打卡  ", "失败", "！\n")
	fmt.Println("XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX")
}
